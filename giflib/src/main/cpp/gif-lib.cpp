...
Java_com_whx_giflib_GifHandler_openFile(
        JNIEnv *env,
...
Java_com_whx_giflib_GifHandler_getWidthN(JNIEnv *env, jobject thiz, jlong gif_info) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_whx_giflib_GifHandler_getHeightN(JNIEnv *env, jobject thiz, jlong gif_info) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_whx_giflib_GifHandler_getLengthN(JNIEnv *env, jobject thiz, jlong gif_info) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_whx_giflib_GifHandler_renderFrameN(JNIEnv *env, jobject thiz, jlong gif_info,
